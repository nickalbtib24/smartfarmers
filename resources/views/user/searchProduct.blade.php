        ...
        <div class="row product-list">
            ...
            <div class="col-sm-6 col-md-4 product-item">
                <div class="product-container">
                    <div class="row">
                        <div class="col-md-12"><a href="{{route('verProductoUsuario',$producto->id)}}" class="product-image"><img style="margin-left:55px;height: 200px;" src="{{asset($producto->imagen)}}"></a></div>
