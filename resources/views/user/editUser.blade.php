                ...
                <BR></BR>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-6" style="margin-top:42px">
                            <label style="font-size: 20px !important; margin-left:0px"></label>
                            <a href="{{route('editarContrasenaComoUsuario')}}"> Editar Contraseña</a>   
                        </div>
                    </div>
                    <hr>
                    <div class="form-row">
                        <div class="col-md-12 content-right">
                            ...
                            <a class="btn btn-danger form-btn" href="{{Auth::user()->roles()->first()->name === 'Administrator' ? route('homeAdmin') : route('homeNormal')}}">CANCELAR </a>
                        </div>
                        <BR></BR>
                        <BR></BR>
