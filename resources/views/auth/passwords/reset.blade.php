        ...
        <div class="row">
            <div class="col" align="center">
                <main class="container">
                    <div class="row">
                        <div class="col" align="center"><label id="main-label-forgot">LLena los campos para reestablecer tu contraseña</label></div>
                    </div>
                    <div class="row">
                        <div class="col" align="center"><label id="label-forgot">Los campos con * son obligatorios</label></div>
                    </div>
                </main>
            </div>
        </div>
